...
def _import_offline_modules():
    """
    Import the two offline sub-modules in a robust way.
    Expected modules:
      - gripanything.core.vggt_reconstruct: VGGTConfig, VGGTReconstructor
      - gripanything.core.pc_postprocess_and_align: Config, process_pointcloud
    Adjust module names if your filenames differ.
    """
    try:
        from gripanything.core.vggt_reconstruct import VGGTConfig as _VGGTConfig, VGGTReconstructor as _VGGTReconstructor
        from gripanything.core.pc_postprocess_and_align import Config as _PostConfig, process_pointcloud as _process_pointcloud
